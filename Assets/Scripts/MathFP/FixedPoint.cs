...
namespace Logic{
    ...
    public struct FixedPoint : IEquatable<FixedPoint>, IComparable<FixedPoint>{
        ...
        /**
		 * Predefined constant representations for raw value.
		 */

        private static readonly int _PIMul2 = 0x6487E; // PI * 2.0f
        private static readonly int _RPIMul2 = 0x28BE; // 1.0f / (PI * 2.0f)

        const int FractionalPart = 16;

        public static FixedPoint Float00001 { get { return new FixedPoint(6); } }
        public static FixedPoint Float0001 { get { return new FixedPoint(65); } }
        public static FixedPoint Float001 { get { return new FixedPoint(655); } }
        public static FixedPoint Float01 {get { return new FixedPoint(6553); } }
        public static FixedPoint Float02 { get { return new FixedPoint(13107); } }
        public static FixedPoint Float03 { get { return new FixedPoint(19660); } }
        public static FixedPoint Float04 { get { return new FixedPoint(26214); } }
        public static FixedPoint Float05 { get { return new FixedPoint(32768); } }
        public static FixedPoint Float06 { get { return new FixedPoint(39321); } }
        public static FixedPoint Float07 { get { return new FixedPoint(45875); } }
        public static FixedPoint Float08 { get { return new FixedPoint(52428); } }
        public static FixedPoint Float09 { get { return new FixedPoint(58982); } }

        public static FixedPoint CustomRaw(int raw){
        ...
        public FixedPoint Fraction(){
            return new FixedPoint(_raw % (1 << FractionalPart));
        }
        ...
        private static int Mul(int s1, int s2){
            return (int) (((Int64) s1*s2) >> FractionalPart);
        }

        private static int Div(int s1, int s2){
            return (int) (((Int64) s1 << FractionalPart)/s2);
        }
        ...
        public static explicit operator short(FixedPoint value){
            return (short) (value._raw >> FractionalPart);
        }

        public static implicit operator FixedPoint(short value){
            return new FixedPoint(value << FractionalPart);
        }

        public static implicit operator int(FixedPoint value){
            return value._raw >> FractionalPart;
        }
        ...
        public static implicit operator float(FixedPoint value){
            return (float) value._raw/(1 << FractionalPart);
        }

        public static explicit operator FixedPoint(float value){
            return new FixedPoint((int) (value*(1 << FractionalPart)));
        }

        /**
		 * Helper methods and overrides.
		 */
        ...
        public override string ToString(){
            ...
            //return ((float) _raw/(1 << FractionalPart)).ToString();
        }
