...
public class UfoBehavior : EntityBehavior
{
    ...
    public override void UpdateLogics(FixedPoint dt, GameController gc)
    {
        ...
        Entity closestUfo = gc.FindClosestEntity(entity, (e, f) => e is Ufo);

        if (closestUfo != null)
        {
            var diff = (closestUfo.position - entity.position);
    ...
    private void Shoot(GameController gc)
    {
        ...
        if (closestEntity != null)
        {
            ...
            gc.SpawnBlast(ufo.position, direction, ufo);
        }
    }
}
...
public class BehaviorController
{
    ...
    {
        foreach (var e in gameController.entities.ToList())
        {
